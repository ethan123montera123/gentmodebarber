...
<body class="bg-gray-100 flex justify-center items-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-96" id="form">
        ...
        <form  name="form" action="login.php" method="POST">
            ...
            <div class="mb-6">
                <input type="submit" name="submit" value="Login" class="bg-indigo-500 text-white w-full py-2 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600">
            </div>
        </form>
